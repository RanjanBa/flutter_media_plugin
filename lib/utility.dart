class FieldUtility {
  ...
  static const String song_key_tag = "id";

  // ignore: non_constant_identifier_names
  static const String song_title_tag = "title";

  // ignore: non_constant_identifier_names
  static const String song_artists_tag = "artists";

  // ignore: non_constant_identifier_names
  static const String song_album_tag = "album";

  // ignore: non_constant_identifier_names
  static const String song_album_art_url_tag = "artUrl";

  // ignore: non_constant_identifier_names
  static const String song_url_tag = "url";

  // ignore: non_constant_identifier_names
  static const String playlist_name = "playlistName";

  // ignore: non_constant_identifier_names
  static const String media_playlist = "mediaPlaylist";
...
class ExoPlayerUtility {
  // ignore: non_constant_identifier_names
  static const int REPEAT_MODE_OFF = 0;
