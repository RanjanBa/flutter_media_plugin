class FieldUtility {
  ...
  static final String song_key_tag = "id";

  // ignore: non_constant_identifier_names
  static final String song_title_tag = "title";

  // ignore: non_constant_identifier_names
  static final String song_artists_tag = "artists";

  // ignore: non_constant_identifier_names
  static final String song_album_tag = "album";

  // ignore: non_constant_identifier_names
  static final String song_album_art_url_tag = "artUrl";

  // ignore: non_constant_identifier_names
  static final String song_url_tag = "url";
...
class ExoPlayerUtility {
  ...
  // ignore: non_constant_identifier_names
  static final int REPEAT_MODE_ONE = 1;

  /// "Repeat All" mode to repeat the entire timeline infinitely.
  // ignore: non_constant_identifier_names
  static final int REPEAT_MODE_ALL = 2;
...
class DownloadUtility {
  ...
  // ignore: non_constant_identifier_names
  static final int STATE_REMOVING = 5;

  /// The download will restart after all downloaded data is removed. */
  // ignore: non_constant_identifier_names
  static final int STATE_RESTARTING = 7;
}
